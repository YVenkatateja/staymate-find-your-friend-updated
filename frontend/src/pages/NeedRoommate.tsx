  ...
  const options = [
    {
      ...
      subtitle: "List your space and find compatible roommates",
      icon: UserPlus,
      color: "from-blue-400 to-blue-500",
      features: ["Create detailed profile", "Set preferences", "Get matched with compatible people", "Photo verification", "Background check options"]
    },
    {
      id: "view",
      title: "View People Who Need Roommates",
      description: "Browse Available Spaces",
      subtitle: "Find someone looking for a roommate",
      icon: Eye,
      color: "from-teal-400 to-teal-500",
      features: ["Browse profiles", "Filter by location", "Contact directly", "View photos", "Read reviews"]
    }
  ];
        ...
        <div className="mb-12">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in">
              Find Your Perfect 
              <span className="block text-primary">Roommate Match</span>
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in">
              Whether you're looking to register as someone who needs a roommate or browse people looking for roommates, 
              we'll help you find the perfect match based on compatibility and preferences.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">People Need Roommates</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Identity & Background</p>
            </div>
          </div>
        </div>
      </main>
